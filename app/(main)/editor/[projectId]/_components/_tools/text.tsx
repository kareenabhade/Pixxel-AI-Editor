...
import { AlignCenter, AlignJustify, AlignLeft, AlignRight, Bold, Italic, LucideProps, Trash2, Type, Underline } from "lucide-react";
...
const TextControls = () => {
  ...
  const applyFontFamily = (family:string)=>{
    ...
    function applyFontSize(size:any): void {
        if(!selectedText) return;
    ...
    function applyTextAlign(alignment:any){
           if(!selectedText) return;
      ...
      {selectedText && (
        <div className="border-t border-white/10 pt-6">
          ...
          <div className="space-y-2 mb-4">
            ...
            {/* You will add your dropdown here */}
            <select
               value={fontFamily}
...
function setChanged(arg0: (c: any) => any) {
